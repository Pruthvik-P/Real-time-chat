...
const ChatList = () => {
  ...
  console.log("chats:", chats, Array.isArray(chats));
  ...
  useEffect(() => {
    ...
    const handleChatUpdate = (data: {chatId: string, lastMessage: MessageType}) => {
      console.log("Recieved updated chats", data.lastMessage);
  ...
  return (
    <div
      className="fixed inset-y-0 * pb-20 lg:pb-0 lg:max-w-94.75 lg:block border-r border-border bg-sidebar max-w-[calc(100%-40px)]
    w-full left-10 z-98
    "
    >
