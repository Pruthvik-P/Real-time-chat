...
const AsideBar = () => {
  ...
  <aside className="top-0 fixed inset-y-0 w-11 left-0 z-9999 h-svh bg-primary/85 shadow-sm">
    <div className="w-full h-full px-1 pt-1 pb-6 flex flex-col item-center justify-between">
      <Logo
...
<div role="button">
  <AvatarWithBadge name={user?.name || "unKnown"} src={user?.avatar || ""} isOnline={isOnline} />
